...
class OrderTest {
    ...
    void shouldThrowExceptionWhenCreatingOrderWithoutItems() {
        ...
        var exception = assertThrows(BusinessException.class, () -> {
            Order.createFromCart(cart, "Cliente", "cliente@email.com", "11999999999", "Rua A", "123", null, "Centro", "Sao Paulo", "SP", "01000-000");
        });
    ...
    void shouldThrowExceptionWhenCreatingOrderWithNullCart() {
        var exception = assertThrows(BusinessException.class, () -> {
            Order.createFromCart(null, "Cliente", "cliente@email.com", "11999999999", "Rua A", "123", null, "Centro", "Sao Paulo", "SP", "01000-000");
        });
